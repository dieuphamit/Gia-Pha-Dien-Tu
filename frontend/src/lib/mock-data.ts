...
export const MOCK_PEOPLE: TreeNode[] = [
    ...
    { handle: 'P020', displayName: 'Nguyễn Phạm Đăng Doanh',gender: 1, generation: 4, birthYear: 2009, isLiving: true,  isPrivacyFiltered: false, isPatrilineal: false, families: [],        parentFamilies: ['F007'] },
    ...
    { handle: 'P027', displayName: 'Nguyễn Thị Thuỳ Tiên',  gender: 2, generation: 4, birthYear: 1998, isLiving: true,  isPrivacyFiltered: false, isPatrilineal: false, families: ['F009'],  parentFamilies: ['F007'] },
...
export const MOCK_FAMILIES: TreeFamily[] = [
    ...
    { handle: 'F007', fatherHandle: 'P018', motherHandle: 'P006',   children: ['P019', 'P020', 'P021', 'P027', 'P024'] },
    { handle: 'F008', fatherHandle: 'P026', motherHandle: 'P021',   children: ['P022', 'P023'] },
    { handle: 'F009', fatherHandle: 'P025', motherHandle: 'P027',   children: [] },
];
